...
class Animation:
  def __init__(self, map, schedule):
    ...
    for d, i in zip(map["agents"], range(0, len(map["agents"]))):
      ...
      self.ax.text(d["goal"][0] - 0.09, d["goal"][1] - 0.09, str(i))
    for d, i in zip(map["agents"], range(0, len(map["agents"]))):
      name = d["name"]
...
if __name__ == "__main__":
  ...
  parser.add_argument("--map", default="mission/input/5/input1.yaml"  ,help="input file containing map")
  parser.add_argument("--schedule", default="mission/output/5/output1.yaml" ,help="schedule for agents")
  parser.add_argument('--video', dest='video', default='sample.gif', help="output video file (or leave empty to show on screen)")
